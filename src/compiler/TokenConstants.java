...
public class TokenConstants {
  ...
  public static final int STR_CONST = 40; //string 常量
  public static final int RPAREN = 36;
  public static final int NOT = 21;
  public static final int TYPEID = 43; //identified
  ...
  public static final int OF = 16; // case 中使用
  public static final int EOF = 0; //文件读取走到最后时给出
  public static final int INT_CONST = 41; //整型类型
  ...
  public static final int LET_STMT = 9; //NOT
  public static final int THEN = 12;
  public static final int BOOL_CONST = 42;//BOOL
